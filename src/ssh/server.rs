...
pub(crate) struct ClientHandler {
    ...
    pub(crate) terminal_term: String,
    pub(crate) terminal_env: terminal::TerminalCapabilityEnv,
    pub(crate) terminal_capabilities: terminal::TerminalCapabilities,
    pub(crate) keyboard_enhancements_active: bool,
...
impl ClientHandler {
    fn new(
        ...
        Self {
            ...
            terminal_term: String::new(),
            terminal_env: terminal::TerminalCapabilityEnv::default(),
            terminal_capabilities: terminal::TerminalCapabilities::default(),
