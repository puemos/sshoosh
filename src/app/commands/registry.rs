    ...
    pub fn palette_items(&self, snapshot: &Snapshot) -> Vec<PaletteItem> {
        let mut items = vec![
            PaletteItem {
                ...
                shortcut: Some("Ctrl-X T".to_string()),
            ...
            PaletteItem {
                ...
                shortcut: Some("Ctrl-X D".to_string()),
                executor: CommandExecutor::Prompt {
            ...
            PaletteItem {
                ...
                category: "Create".to_string(),
                shortcut: Some("Ctrl-X C".to_string()),
                executor: CommandExecutor::Prompt {
            ...
            PaletteItem {
                ...
                category: "Read state".to_string(),
                shortcut: Some("Ctrl-X U".to_string()),
            ...
            PaletteItem {
                ...
                category: "Navigate".to_string(),
                shortcut: Some("Ctrl-X N".to_string()),
            ...
            PaletteItem {
                ...
                category: "System".to_string(),
                shortcut: Some("Ctrl-X Q".to_string()),
